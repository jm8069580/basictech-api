...
export async function seedBasicTechProfile() {
  console.log('Seeding BasicTech profile (computer products)...')
  ...
  const productsData = [
    {
      ...
      description:
        'Tarjeta grafica de alto rendimiento con iluminacion RGB y refrigeracion avanzada',
      specs: {
        Memoria: '16GB GDDR6X',
        'Nucleos CUDA': '9728',
        'Reloj Base': '2205 MHz',
    ...
    },
    {
      ...
      description:
        'Monitor gaming curvo ultrawide con 240Hz y 1ms de respuesta',
      specs: {
    ...
    },
    {
      ...
      description:
        'Audifonos gaming inalambricos con sonido espacial DTS:X',
      specs: {
        Driver: '53mm',
    ...
    },
    {
      ...
      description:
        'SSD NVMe M.2 de alta velocidad para gaming y productividad',
      specs: {
        Capacidad: '2TB',
        Lectura: '3,500 MB/s',
    ...
    },
    {
      ...
      description:
        'Procesador de 16 nucleos y 32 hilos para rendimiento extremo',
      specs: {
        Nucleos: '16',
        Hilos: '32',
        'Reloj Base': '4.5 GHz',
